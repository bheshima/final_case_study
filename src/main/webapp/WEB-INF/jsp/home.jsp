...
<body>
	...
	<div class="header">
		<h1>Recipe Share</h1>
		<h5>Share your favorite recipes with the world.</h5>
	</div>
...
<footer class="footer-distributed">
			...
			<div class="footer-center">
				...
				<div>
					...
					<p><span>444 S. Cedros Ave</span> Charlotte, North Carolina</p>
				</div>
	...
	<script type="application/javascript" src="/js/home.js"/> 
</body>